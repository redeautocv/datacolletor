...
for i in range(len(app.controllers.numberannoument) ):
    ...
    print("______-----------------------------------_____")
    #dataanuncio.append((app.controllers.marcaCarro[i][0].text ,app.controllers.numeroLugares[i][0].text,app.controllers.taxasextras[i][0].text,app.controllers.preco[i][0].text,combustivel  ))
