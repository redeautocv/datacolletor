...
with open("C:/Users/HP/Documents\datacolletor\app", "r", encoding="utf-8") as file:
...
for i in range(len(numberannoument)):
 ...
 tagnome=soup.find_all('div' ,{'class':"lp-pom-text-"+str(numberannoument[i]+2)})
 for x in tagnome:
