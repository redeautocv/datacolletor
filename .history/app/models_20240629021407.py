...
for i in range(13):
    ...
    taxaextras=app.controllers.taxasextras[0]
    dataanuncio.append(( tipocarro,numeroLugar,app.controllers.taxasextras[0],app.controllers.preco[i][0].text,app.controllers.numeroLugares[i][0].text  ))
