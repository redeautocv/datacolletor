...
for i in range(13):
    ...
    dataanuncio.append(( ,app.controllers.numeroLugares[i][0].text,app.controllers.taxasextras[0],app.controllers.preco[i][0].text,app.controllers.numeroLugares[i][0].text  ))
