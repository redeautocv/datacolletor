...
db= conectDb.cursor()
db.execute( 'CREATE TABLE carro(FORNECEDOR INT,FOTOGRAFIA VARCHAR(45),NUMERO_PASSAGEIRO INT,MARCA VARCHAR(45),MODELO VARCHAR(45),PRECO DOUBLE,CAIXA_VELOCIDADE VARCHAR(45),
    NUMERO_PORTAS INT,
